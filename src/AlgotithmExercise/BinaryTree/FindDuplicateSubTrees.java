...
/**
    ...
    Map<AlgotithmExercise.String, TreeNode> seen = new HashMap<AlgotithmExercise.String, TreeNode>();
    ...
    public AlgotithmExercise.String dfs(TreeNode node) {
        if (node == null) {
            return "";
        }
        ...
        sb.append(")");
        AlgotithmExercise.String serial = sb.toString();
